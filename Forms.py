...
def NewPantalla():
    ...
    def formularios():
        ...
        label1 = tkinter.Label(canvas, text='Nombre completo:', background="#4d7091", fg="black", font= ("Helvetica", 13), width=15) 
        ...
        label2 = tkinter.Label(canvas, text='Edad:', background="#4d7091", fg="black", font= ("Helvetica", 13), width=15) 
        ...
        label3 = tkinter.Label(canvas, text='Sexo:', background="#4d7091", fg="black", font= ("Helvetica", 13), width=15) 
        ...
        label0_1 = tkinter.Label(canvas, text='Médico que atiende:', background="#4d7091", fg="black", font= ("Helvetica", 13), width=20) 
        ...
        label_fecha = tkinter.Label(canvas, text='Fecha de visita:', background="#4d7091", fg="black", font= ("Helvetica", 13), width=15)
        ...
        label4 = tkinter.Label(canvas, text='¿Algún miembro de la familia ha sido diagnósticado previamente con melanoma?', background="#4d7091", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        label6 = tkinter.Label(canvas, text='¿Hay antecendentes en usted o en su familia que haya llevado a cambios en el \ncomportamiento, como una mayor conciencia de protección solar?', background="#4d7091", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        label8 = tkinter.Label(canvas, text='¿Cuál?', background="#4d7091", fg="black", font= ("Helvetica", 13), width=20) 
        ...
        # Formulario 2
        formulario_frame2 = tkinter.Frame(tab2, background="#4B54A5")
        formulario_frame2.pack(fill='both', expand=True)
        formulario_frame2.place(relx=0, rely=0)

        canvas = tkinter.Canvas(formulario_frame2, background="#4B54A5")
        ...
        subformulario_frame2 = tkinter.Frame(canvas, background="#4B54A5")
        ...
        for i, option in enumerate(options_2):
            radio_2 = tkinter.Radiobutton(canvas, text=option, variable=select_option_2, value=option, background="#4B54A5", font= ("Helvetica", 13))
            canvas.create_window((240+(i*130), 470+i), window=radio_2, anchor='w')
        
        label_5 = tkinter.Label(canvas, text='Si la respuesta es sí, describa cuáles han sido los cambios', background="#4B54A5", fg="black", font= ("Helvetica", 13), width=70) 
        canvas.create_window((40, 520), window=label_5, anchor='w')

        scroll_area_3 = scrolledtext.ScrolledText(canvas, wrap=tkinter.WORD)
        scroll_area_3.insert(tkinter.END, ' ')
        canvas.create_window((60, 590), window=scroll_area_3, anchor='w', width=620, height=60)

        label_6 = tkinter.Label(canvas, text='¿Has tenido algún episodio previo de quemadura solar grave en la \ninfancia o en la adultez?', background="#4B54A5", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        for i, option in enumerate(options_3):
            radio_3 = tkinter.Radiobutton(canvas, text=option, variable=select_option_3, value=option, background="#4B54A5", font= ("Helvetica", 13))
            canvas.create_window((240+(i*130), 720+i), window=radio_3, anchor='w')
        
        label_7 = tkinter.Label(canvas, text='¿Has sido diagnosticado con otros problemas de piel, como queratosis actínicas \no cáncer de piel no melanoma?', background="#4B54A5", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        for i, option in enumerate(options_4):
            radio_4 = tkinter.Radiobutton(canvas, text=option, variable=select_option_4, value=option, background="#4B54A5", font= ("Helvetica", 13))
            canvas.create_window((240+(i*130), 830+i), window=radio_4, anchor='w')

        label_8 = tkinter.Label(canvas, text='¿Has tenido alguna biopsia de lesiones cutáneas sospechosas de \nmelanoma en el pasado?', background="#4B54A5", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        # Formulario 3
        formulario_frame3 = tkinter.Frame(tab3, background="#679B39")
        formulario_frame3.pack(fill='both', expand=True)
        formulario_frame3.place(relx=0, rely=0)

        canvas = tkinter.Canvas(formulario_frame3, background="#679B39")
        ...
        subformulario_frame3 = tkinter.Frame(canvas, background="#679B39")
        ...
        lbl_1 = tkinter.Label(canvas, text='¿Has utilizado camas de bronceado con regularidad en el pasado?', background="#679B39", fg="black", font= ("Helvetica", 13), width=70) 
        canvas.create_window((40, 30), window=lbl_1, anchor='w')

        #Radiobuttons
        opt_1 = ["Si", "No"]
        selectoption_1 = tkinter.StringVar(value=opt_1[0])
        style.configure('TRadiobutton', background="#679B39", foreground="black")

        for i, option in enumerate(opt_1):
            rad_1 = tkinter.Radiobutton(canvas, text=option, variable=selectoption_1, value=option, background="#679B39", font= ("Helvetica", 13))
            canvas.create_window((240+(i*130), 80+i), window=rad_1, anchor='w')

        lbl_2 = tkinter.Label(canvas, text='¿Con qué frecuencia realizas autoexámenes de la piel para buscar cambios o \nlesiones inusuales?', background="#679B39", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        lbl_3 = tkinter.Label(canvas, text='¿Utilizas protector solar regularmente cuando te expones al sol?', background="#679B39", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        lbl_4 = tkinter.Label(canvas, text='¿Tienes una rutina regular de protección solar, como usar ropa protectora y sombreros?', background="#679B39", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        lbl_5 = tkinter.Label(canvas, text='¿Has recibido educación sobre la detección temprana de melanoma y \ncómo hacer autoexámenes de la piel?', background="#679B39", fg="black", font= ("Helvetica", 13), width=70) 
        ...
        for i, option in enumerate(opt_3):
            rad_3 = tkinter.Radiobutton(canvas, text=option, variable=selectoption_3, value=option, background="#679B39", font= ("Helvetica", 13))
            canvas.create_window((240+(i*130), 300+i), window=rad_3, anchor='w')

        def Datos_recabados_3():
        ...
        # Asegúrate de asociar esta función al botón correspondiente
        boton_formulario_3 = Button(canvas, image=n_img, border=0, command=lambda: Datos_recabados_3(), cursor="hand2", activebackground="#679B39", bg="#679B39")
        canvas.create_window((700, 540), window=boton_formulario_3)
    ...
    def menu():
        ...
        Botones(0, 50, 'Acerca de', color4,color2, 1, lambda: Aboutus(app2, ruta, ruta2))
        Botones(0, 90, 'Cáncer de piel', color4,color2, 1, lambda: Cancer_d_piel(app2, ruta, ruta2))
        ...
        Botones(0, 250, 'Home', color4,color2, 1, lambda: Home(app2))
