...
def Acerca_de(app4, imagen_logo2, img):
    ...
    def AS():
        ...
        nosotros = """ Hola, nosotros somos LaB-DETECTION e hicimos este software para apoyarte 
        en el diagnóstico del cáncer de piel del tipo melanoma, decidimos hacer este 
        proyecto para apoyar a médicos y pacientes, nosotros no pretendemos sustituir
        a médicos y mucho menos hacer autodiagnósticos, pretendemos que esta 
        herramienta pueda darle al médico un panorama más detallado sobre la lesión."""
        label1 = tkinter.Label(canvas, text=nosotros, background=color, fg="white", font= ("Helvetica", 13), width=70)
        canvas.create_window((20, 80), window=label1, anchor='w')
        ...
        label3 = tkinter.Label(canvas, text="Yeraldi Lizeth Sánchez Sandoval", background=color, fg="white", font= ("Helvetica", 13), width=30)
        ...
        label5 = tkinter.Label(canvas, text="Brandon de Jesús Bravo Mendoza", background=color, fg="white", font= ("Helvetica", 13), width=30)
